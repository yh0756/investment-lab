...
export const metadata = {
  title: "문의",
  description: "투자실험실의 계산 오류, 기능 개선 및 운영 정책 관련 이메일 문의 방법을 안내합니다."
};
    ...
    <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      <header>
        ...
        <p className="mt-4 text-lg leading-8 text-slate-600">
          계산 오류, 기능 개선 또는 운영 정책에 관한 문의는 이메일로 보내주세요.
      ...
      <div className="mt-8 space-y-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <section>
          ...
          <div className="mt-4 rounded-2xl border border-red-200 bg-red-50 p-5 text-sm leading-6 text-red-900">
            계좌번호, 증권사 로그인 정보, 비밀번호, 주민등록번호, 카드번호, 신분증이나 실제 거래내역 원본처럼
        ...
        <section>
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-black text-slate-950">문의 처리 범위</h2>
          </div>
          <p className="mt-4 leading-7 text-slate-700">
            접수된 내용은 서비스 오류 확인과 개선을 위해 검토합니다. 모든 제안의 반영이나 개별 답변을 보장하지 않으며,
            투자 종목 추천이나 개인별 세금·법률 상담은 제공하지 않습니다.
          </p>
        </section>
      </div>
    </main>
