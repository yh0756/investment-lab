...
export default function Page(){return <><JsonLd name="배당성장 ETF 역전 시점 계산기" description="고배당 ETF와 배당성장 ETF 비교" path="/calculators/dividend-growth"/><DividendGrowthCalculator/></>}
