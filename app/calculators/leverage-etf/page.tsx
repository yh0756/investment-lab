...
export default function Page(){return <><JsonLd name="레버리지 ETF 변동성 손실 계산기" description="2배·3배 ETF 경로 효과 시뮬레이션" path="/calculators/leverage-etf"/><LeverageCalculator/></>}
